...
export type StockWhereInput = {
  ...
  key?: Prisma.StringFilter<"Stock"> | string
  price?: Prisma.IntFilter<"Stock"> | number
  prevPrice?: Prisma.IntFilter<"Stock"> | number
...
export type StockScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"Stock"> | string
  price?: Prisma.IntWithAggregatesFilter<"Stock"> | number
  prevPrice?: Prisma.IntWithAggregatesFilter<"Stock"> | number
...
export type StockUpdateInput = {
  ...
  prevPrice?: Prisma.IntFieldUpdateOperationsInput | number
...
export type StockOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "price" | "prevPrice" | "updatedAt", ExtArgs["result"]["stock"]>
...
export interface StockDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const stockWithKeyOnly = await prisma.stock.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Stocks and only return the `key`
   * const stockWithKeyOnly = await prisma.stock.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Stocks and only return the `key`
   * const stockWithKeyOnly = await prisma.stock.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface StockFieldRefs {
  readonly key: Prisma.FieldRef<"Stock", 'String'>
  readonly price: Prisma.FieldRef<"Stock", 'Int'>
  readonly prevPrice: Prisma.FieldRef<"Stock", 'Int'>
